                ...
                <Card>
                    ...
                    {isEditing ? (
                        <div className="space-y-4">
                            ...
                            <Select label="Fitness Goal" value={formData.goal as string} onChange={() => setFormData({ ...formData, goal: v as 'lose' | 'maintain' | 'gain' })} options={goalOptions} />
                            <div className="gap-3 flex pt-2">
                                ...
                                <Button className="fex-1" onClick={handleSave}>
                                    Save Changes
                                </Button>
                            </div>
                        </div>
                    ...
                    <Card>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="text-center p-4 bg-emerald-50 dark:bg-emerald-900/10 rounded-xl">
                                <p className="text-2xl font-bold text-emerald-600 dark:text-slate-400">
                                    {stats.totalFoodEntries}
                                </p>
                                <p className="text-sm text-slate-500 dark:text-slate-400">Food Entries</p>
                            </div>
                            <div className="text-center p-4 bg-emerald-50 dark:bg-blue-900/10 rounded-xl">
